...
public interface IDebugExportable {
	void debugExport(com.google.gson.stream.JsonWriter a0, net.minecraft.core.HolderLookup.Provider a1, it.unimi.dsi.fastutil.objects.Reference2IntMap<java.lang.Object> a2, it.unimi.dsi.fastutil.objects.Reference2IntMap<appeng.api.networking.IGridNode> a3) throws java.io.IOException;
}
