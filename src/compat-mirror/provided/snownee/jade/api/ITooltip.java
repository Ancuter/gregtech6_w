...
public interface ITooltip extends net.minecraft.client.gui.narration.NarrationSupplier {
	default void add(net.minecraft.network.chat.Component a0) { throw new UnsupportedOperationException(); }
	default void add(java.util.List<? extends net.minecraft.client.gui.layouts.LayoutElement> a0) { throw new UnsupportedOperationException(); }
}
