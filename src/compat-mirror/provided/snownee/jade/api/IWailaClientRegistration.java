...
public interface IWailaClientRegistration extends snownee.jade.api.platform.PlatformWailaClientRegistration {
	void registerBlockComponent(snownee.jade.api.IComponentProvider<snownee.jade.api.BlockAccessor> a0, java.lang.Class<? extends net.minecraft.world.level.block.Block> a1);
	void registerFluidStorageClient(snownee.jade.api.view.IClientExtensionProvider<snownee.jade.api.view.FluidView.Data, snownee.jade.api.view.FluidView> a0);
}
