...
public interface IComponentProvider<T extends snownee.jade.api.Accessor<?>> extends snownee.jade.api.IToggleableProvider {
	void appendTooltip(snownee.jade.api.ITooltip a0, T a1, snownee.jade.api.config.IPluginConfig a2);
}
