...
public class FluidView {
	public static snownee.jade.api.view.FluidView readDefault(snownee.jade.api.view.FluidView.Data a0) { throw new UnsupportedOperationException(); }

	public record Data(java.util.List<snownee.jade.api.fluid.JadeFluidObject> fluids, long capacity) {
	}
}
