...
public interface IServerExtensionProvider<T> extends snownee.jade.api.IJadeProvider {
	java.util.List<snownee.jade.api.view.ViewGroup<T>> getGroups(snownee.jade.api.Accessor<?> a0);
}
