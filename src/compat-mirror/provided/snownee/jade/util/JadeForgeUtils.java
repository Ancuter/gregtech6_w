...
public class JadeForgeUtils {
	public static java.util.List<snownee.jade.api.view.ViewGroup<snownee.jade.api.view.FluidView.Data>> fromFluidHandler(net.neoforged.neoforge.transfer.ResourceHandler<net.neoforged.neoforge.transfer.fluid.FluidResource> a0) { throw new UnsupportedOperationException(); }
}
