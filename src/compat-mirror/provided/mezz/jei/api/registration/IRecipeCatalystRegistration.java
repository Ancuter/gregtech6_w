...
public interface IRecipeCatalystRegistration {
	void addCraftingStation(mezz.jei.api.recipe.types.IRecipeType<?> a0, net.minecraft.world.level.ItemLike... a1);
	default void addCraftingStation(mezz.jei.api.recipe.types.IRecipeType<?> a0, net.minecraft.world.item.ItemStack... a1) { throw new UnsupportedOperationException(); }
}
