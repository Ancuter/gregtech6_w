...
public abstract class AbstractRecipeCategory<T> implements mezz.jei.api.recipe.category.IRecipeCategory<T> {
	public AbstractRecipeCategory(mezz.jei.api.recipe.types.IRecipeType<T> a0, net.minecraft.network.chat.Component a1, mezz.jei.api.gui.drawable.IDrawable a2, int a3, int a4) { throw new UnsupportedOperationException(); }
}
