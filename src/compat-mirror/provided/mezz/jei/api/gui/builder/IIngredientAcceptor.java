...
public interface IIngredientAcceptor<THIS extends mezz.jei.api.gui.builder.IIngredientAcceptor<THIS>> {
	THIS addItemStacks(java.util.List<net.minecraft.world.item.ItemStack> a0);
