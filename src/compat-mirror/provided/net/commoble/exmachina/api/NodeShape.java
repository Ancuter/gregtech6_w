...
public interface NodeShape {
	boolean isValidFor(net.commoble.exmachina.api.NodeShape a0);
	static net.commoble.exmachina.api.NodeShape ofCube() { throw new UnsupportedOperationException(); }
	static net.commoble.exmachina.api.NodeShape ofSide(net.minecraft.core.Direction a0) { throw new UnsupportedOperationException(); }
}
