...
/** Compile-only shim for Forge 1.7.10's EnumPlantType, removed in neo in favor of tags; values
 *  match 1.7.10 exactly since GregTech6 uses them as IPlantable.getPlantType's return type. */
