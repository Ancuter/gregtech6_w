...
/** Compile-only shim for Forge 1.7.10's IShearable, removed in neo; GregTech6's leaf blocks
 *  implement it and check instanceof it. PORT-TODO(F-shear): real shearing not yet ported. */
