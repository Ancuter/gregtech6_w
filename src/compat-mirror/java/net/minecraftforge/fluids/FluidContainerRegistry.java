...
/** Compile-only mirror of the removed Forge fluid-container registry; neo has no single auto-registry
 *  for full/empty container pairs, so registration stays a no-op stub. PORT-TODO(F5, bucket/canister auto-registry). */
