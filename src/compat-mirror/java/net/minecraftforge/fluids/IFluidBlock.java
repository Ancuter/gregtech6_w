...
/** Compile-only shim for Forge 1.7.10's IFluidBlock, removed in neo in favor of LiquidBlock plus
 *  FluidState; no GregTech6 block implements it, only casts to it. PORT-TODO(F-fluid): real detection and draining. */
