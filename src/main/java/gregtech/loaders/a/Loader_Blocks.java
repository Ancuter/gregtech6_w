...
public class Loader_Blocks implements Runnable {
	...
	public void run() {
		...
		// All oils are now swimmable with a viscosity scale instead of the original's binary cobweb-like setting
		// on just two heavy oils, via BlockBaseFluid.setMedium; the values are a starting calibration, judged against play.
