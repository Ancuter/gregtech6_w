...
public class Loader_Worldgen implements Runnable {
	...
	public void run() {
		...
		// Vein added on top of the original: 1.7.10 sourced meteoric iron from GalactiCraft/HBM, both absent here.
		// Gated by ae2/ReplaceMeteoriteGeneration: a meteorite excludes the vein, and vice versa, not merely disabled.
