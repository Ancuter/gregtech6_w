...
//      OreDictManager.INSTANCE.setTarget(OP.plate          , MT.WoodTreated            , MD.IE, "treatedWood", 0);
		...
		// AE2 26.1 has no certus ore block at all (its crystal source is a meteor budding chain), so there is
		// nothing to point the unification target at; skipping silently avoids a false "item does not exist" complaint.
