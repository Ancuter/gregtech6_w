...
public abstract class WorldgenObject {
	...
	public boolean enabled(WorldGenLevel aWorld, int aDimType) {
		...
		// Was a human-readable dimension name from the removed WorldProvider; the config key is now the dimension's
		// ResourceKey identifier instead, equally readable but without name-collision risk between different mods' dimensions.
