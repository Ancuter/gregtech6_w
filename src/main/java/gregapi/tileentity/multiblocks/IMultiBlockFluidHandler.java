...
public interface IMultiBlockFluidHandler extends ITileEntityMultiBlockController {
	...
	/** Seventh contract method, unneeded in 1.7.10 since a part declared IFluidHandler directly; in neo only a
	 *  registered capability is visible outward, and without it the wall reported no tanks, hiding contents from Jade. */
