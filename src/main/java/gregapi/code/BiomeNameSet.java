...
public class BiomeNameSet extends AbstractSet<String> {
	...
	/** Biome identity in neo is its registry key (Holder.unwrapKey().identifier()), the same lookup already
	 *  used by GT6WorldGenerator; a bare Biome carries no back-reference to that key on its own. */
