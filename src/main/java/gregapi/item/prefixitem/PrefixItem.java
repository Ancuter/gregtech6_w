...
public class PrefixItem extends Item implements Runnable, IItemUpdatable, IItemBeaconPayment, IItemSmeltingExperience, IPrefixItem, IItemGT, IItemNoGTOverride {
	...
	// meta holds the material id; neo's default getDamage reads the DAMAGE component (0) instead.
	@Override public int getDamage(ItemStack aStack) {return getMaxDamage(aStack) > 0 ? super.getDamage(aStack) : ST.meta_(aStack);}
	// Bridges the new appendHoverText call into the old addInformation method.
